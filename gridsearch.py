...
if __name__ == '__main__':
        ...
        for user_neibor in user_neibor_size:
            for item_neibor in item_neibor_size:
                ...
                for ct in context:
                    ...
                    print(
                        'super_param user_neibor: {} , item_neibor: {} , sample_size: {} , context_hops: {}'
                            .format(user_neibor, item_neibor, sample_size, ct))
                    ...
                    train_res.field_names = ["super_param: user_neibor item_neibor sample_size context_hops ",
                                             "training time", "tesing time", "Loss", "recall", "ndcg",
                                             "precision", "hit_ratio", "mean Average Precision", "auc", "f1"]
                    train_res.add_row(
                        [(user_neibor, item_neibor, sample_size, ct), train_grid_end - train_grid_start,
                         test_e_t - test_s_t, loss.item(), ret['recall'],
                         ret['ndcg'],
                         ret['precision'], ret['hit_ratio'], ret['map'], ret['auc'], ret['f1']]
                    )
                    print(train_res)
                    super_param[(user_neibor, item_neibor, sample_size, ct)] = [ret['recall'],
                                                                                ret['ndcg'],
                                                                                ret['precision'],
                                                                                ret['hit_ratio'],
                                                                                ret['map'], ret['auc'],
    ...
    gridsearch_res.field_names = ["super_param: user_neibor item_neibor sample_size context_hops",
                                  "recall", "ndcg",
                                  "precision", "hit_ratio", "mean Average Precision", "auc", "f1"]
